...
const FAQ_DATA: FaqCategory[] = [
  {
    ...
    faqs: [
      ...
      { 
        ...
        answer: 'Yes, Vaitour offers a highly flexible modification system. You can request to change your tour dates, switch departure times, or add additional travelers directly from your "My Bookings" dashboard without having to cancel the entire reservation. If the local supplier has availability for the newly requested date, the modification is approved instantly. If you are adding guests, you will simply be prompted to pay the fare difference. Please note that major modifications attempted within 24 hours of the scheduled departure are generally locked by the system to prevent logistical chaos for our hosts.' 
      },
      { 
        question: 'Do I need to print my tickets or vouchers?', 
        answer: 'Absolutely not. Vaitour is a deeply eco-conscious platform and operates on a 100% paperless ticketing ecosystem. Upon confirmation, you will receive a dynamic digital e-ticket containing a unique, cryptographically secure QR code. On the day of your experience, simply open the Vaitour mobile app or your email and present the bright screen to your local guide. They will scan the QR code using their host application to verify your identity and check you in instantly. However, for extremely remote tours (like deep jungle treks or oceanic sailing) where mobile data may be nonexistent, we highly recommend taking a screenshot of the QR code beforehand.' 
      },
      {
  ...
  },
  {
    ...
    faqs: [
      { 
        ...
        answer: 'Punctuality is critical, especially for group tours where 20 other travelers are waiting. If you realize you are going to be late due to terrible traffic or a delayed train, your absolute first priority is to use the Vaitour in-app messaging system to instantly notify your local guide. Many hosts have a strict "15-Minute Grace Period" and may try to hold the bus or boat for you. However, if you fail to communicate and miss the departure entirely, it is officially classified as a "No-Show." Under standard policies, No-Shows are strictly non-refundable because the host held the physical seat for you and turned away other paying customers.' 
      },
      { 
        question: 'How do I easily locate the meeting point in a foreign city?', 
        answer: 'We have engineered away the stress of getting lost. Your digital e-ticket contains the exact GPS coordinates of the meeting point, seamlessly integrated with Google Maps and Apple Maps. Simply tap the "Navigate" button in the Vaitour app, and your phone will provide turn-by-turn walking or driving directions. Furthermore, hosts are required to provide highly specific visual clues in the ticket description (e.g., "I will be standing next to the bronze lion statue wearing a bright yellow Vaitour polo shirt"). If you are still lost, you can message the host directly or call their provided emergency day-of-tour phone number.' 
      }
    ]
  },
  {
    ...
    faqs: [
      { 
        ...
        answer: 'Yes, with extreme prejudice. We do not allow random individuals to casually list tours on Vaitour. Our Trust & Safety division manually audits every single supplier before their listing goes live. They are required to submit official governmental business licenses, verifiable proof of operational history, and comprehensive public liability insurance certificates. Furthermore, we deploy active Machine Learning models that monitor their ongoing performance. If a supplier begins receiving concerning reviews regarding safety equipment or reckless driving, their account is instantly suspended pending a deep-dive internal forensic investigation.' 
      },
      { 
        question: 'Does Vaitour provide comprehensive travel insurance?', 
        answer: 'Vaitour is a technological booking intermediary, not a licensed insurance underwriter. Therefore, we do not provide blanket medical or trip cancellation insurance. We aggressively advocate that every single traveler purchases a robust, third-party travel insurance policy immediately after booking their flights and tours. A good policy will protect you from massive financial loss if you must cancel a non-refundable booking due to sudden illness, a death in the family, or if you require emergency medical evacuation while abroad. Our support team is fully equipped to provide official "Proof of Cancellation" invoices to help expedite your insurance claims.' 
      }
    ]
  }
];
