...
export const metadata: Metadata = {
  title: 'Help & Support | TravelNest',
  description: 'Comprehensive help center and customer support resources for TravelNest users.',
};
        ...
        <div className="card-panel" style={{ background: '#fff', padding: '40px', borderRadius: '16px', border: '1px solid #e2e8f0', color: '#334155', lineHeight: 1.8 }}>
          ...
          <div style={{ marginBottom: '32px', padding: '16px 20px', background: '#e0f2fe', borderRadius: '8px', borderLeft: '4px solid #0284c7', display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            ...
            <p style={{ margin: 0, color: '#0c4a6e', fontSize: '0.95rem' }}>
              <strong>Support Directory:</strong> This exhaustive directory covers every conceivable aspect of using the TravelNest platform. Whether you are facing a minor technical glitch, an international payment failure, or a critical travel emergency, the protocols outlined here will guide you to immediate resolution.
            </p>
          </div>
          ...
          <section id="sec-2" style={{ marginBottom: '40px' }}>
            ...
            <p>Navigating international payments across dozens of different currencies and banking jurisdictions can occasionally result in localized friction. At TravelNest, we process transactions globally using elite, PCI-DSS certified gateways like Stripe. If you encounter a frustrating "Payment Declined" or "Transaction Failed" error during the checkout process, the root cause is almost entirely dictated by your personal bank's automated fraud algorithms, rather than a failure of the TravelNest platform. Banks frequently flag sudden, high-value international transactionsâ€”especially travel-related purchases processed in a foreign currencyâ€”as suspicious, automatically placing a hard lock on the card to protect you from perceived theft.</p>
          ...
          <section id="sec-5" style={{ marginBottom: '40px' }}>
            ...
            <p>While our engineering teams work around the clock to maintain a flawless, bug-free platform, the massive complexity of interacting with thousands of different mobile devices, heavily customized browsers, and unstable international internet connections means that localized technical glitches are an inevitable reality. If you are experiencing a frustrating technical roadblockâ€”such as a calendar widget refusing to load dates, an endless spinning wheel on the checkout page, or an inability to upload a required profile photoâ€”the solution is usually found in basic client-side troubleshooting. In 90% of cases, these UI anomalies are caused by corrupted browser cache data, aggressive ad-blocking extensions improperly blocking our JavaScript bundles, or outdated browser versions that fail to support modern rendering protocols.</p>
          ...
          <section id="sec-9" style={{ marginBottom: '40px' }}>
            ...
            <p>Travel is a profoundly enriching human experience that must be universally accessible, regardless of physical mobility limitations, neurodivergence, or specialized medical requirements. TravelNest is deeply committed to breaking down the historical barriers that have made travel daunting for the disabled community. We have mandated that all suppliers on our platform must clearly and honestly categorize the accessibility levels of their toursâ€”explicitly noting if a boat has a wheelchair ramp, if a museum tour involves navigating steep, uneven cobblestone staircases, or if a vehicle can safely stow heavy medical equipment like oxygen tanks or motorized scooters.</p>
          ...
          <section id="sec-10" style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginTop: '16px' }}>To facilitate these monumental logistical undertakings, TravelNest provides a dedicated "Group & Corporate Concierge" service. By submitting a detailed group request form outlining your headcount, exact dates, and specific experiential goals, you will be assigned a human concierge expert. This expert will act as your singular point of contact, negotiating bulk discount rates directly with local suppliers, orchestrating complex, multi-day itineraries, and structuring custom, staggered payment plans (such as a 30% upfront non-refundable deposit followed by a final balance payment 30 days before departure). This bespoke service ensures that large-scale corporate or educational events are executed flawlessly, shielding the organizer from the paralyzing stress of managing dozens of moving parts in a foreign country.</p>
          </section>
          ...
          <section id="sec-12" style={{ marginBottom: '40px' }}>
            ...
            <p>The entire qualitative foundation of the TravelNest marketplace is built upon the honest, unflinching, and detailed feedback provided by travelers like you. When an experience concludes, you will receive an automated prompt requesting a public review. We implore you to take this responsibility seriously. Your deeply detailed accounts of an exceptional, highly knowledgeable guide can instantly propel a small local business to massive global success. Conversely, your stark, honest warnings about a disorganized, unsafe, or disappointing tour serve as a critical defense mechanism, protecting thousands of future travelers from wasting their hard-earned money on a subpar experience.</p>
            <p style={{ marginTop: '16px' }}>However, if your experience was not merely mediocre but fundamentally disastrousâ€”if a supplier completely failed to show up, provided broken equipment, or grossly misrepresented the tour itineraryâ€”a public review is not sufficient. In these severe cases, you must immediately escalate the issue by submitting a formal Complaint Ticket to our Resolution Center within 72 hours of the tour's scheduled conclusion. To ensure a rapid and fair mediation, your complaint must be armed with irrefutable evidence. We require you to upload time-stamped photographs of the poor conditions, screenshots of any relevant text messages, and a chronological written account of the failure. Our specialized arbitration team will painstakingly review the evidence, cross-examine the supplierâ€™s defense, and possesses the ultimate authority to unilaterally issue partial or full refunds directly from the supplierâ€™s payouts, ensuring you are justly compensated for the failure.</p>
          </section>
          ...
          <section id="sec-15" style={{ marginBottom: '40px' }}>
            ...
            <p>We recognize that when you are stranded in a foreign country, navigating confusing transit systems across massive time zone differences, waiting 48 hours for a generic email response is utterly unacceptable. Therefore, TravelNest has heavily invested in a sprawling, multi-tiered global support infrastructure designed to provide immediate relief. Our frontline defenses consist of a highly sophisticated, AI-driven chatbot capable of instantly solving basic logistical issuesâ€”such as resending lost e-tickets, answering standard policy questions, or providing immediate translation servicesâ€”in over 40 languages, available 24/7/365.</p>
            <p style={{ marginTop: '16px' }}>When your situation demands the nuanced empathy and complex problem-solving capabilities of a human being, our live support channels are ready. We operate massive, interconnected call centers in North America, Europe, and Asia, ensuring that no matter when disaster strikes, a highly trained agent is awake and ready to assist. Live Text Chat within our mobile application is available 24/7 for immediate, silent assistance, perfect for when you are on a noisy train. For highly complex, multi-faceted emergenciesâ€”such as coordinating a sudden medical evacuation or untangling a catastrophic, multi-city booking failureâ€”our toll-free international phone lines are the preferred avenue. While phone support is generally available 24/7 in English, specialized language support (such as Spanish, Mandarin, or German) may be restricted to standard regional business hours.</p>
          </section>
