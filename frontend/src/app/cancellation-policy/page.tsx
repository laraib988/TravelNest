...
export default function CancellationPolicyPage() {
  return (
    <div className="policy-page-container" style={{ background: '#f8fafc', minHeight: '100vh', paddingBottom: '80px' }}>
      <style dangerouslySetInnerHTML={{ __html: `
        .policy-hero-section { background: #0f172a; padding: 80px 24px; text-align: center; color: #fff; margin-bottom: 60px; }
        .policy-hero-title { font-size: 3.5rem; font-weight: 900; margin-bottom: 20px; letter-spacing: -1px; color: #ffffff; }
        .policy-hero-desc { font-size: 1.15rem; color: #cbd5e1; max-width: 750px; margin: 0 auto; line-height: 1.6; }
        
        .policy-layout { max-width: 1200px; margin: 0 auto; padding: 0 24px; display: grid; grid-template-columns: minmax(280px, 1fr) 3fr; gap: 40px; align-items: start; }
        .policy-sidebar { position: sticky; top: 100px; background: #fff; padding: 24px; border-radius: 12px; border: 1px solid #e2e8f0; max-height: calc(100vh - 120px); overflow-y: auto; }
        .policy-main-content { background: #fff; padding: 40px; border-radius: 16px; border: 1px solid #e2e8f0; color: #334155; line-height: 1.8; }
        ...
        @media (max-width: 768px) {
          .policy-hero-section { padding: 50px 16px; margin-bottom: 40px; }
          .policy-hero-title { font-size: 2.2rem; }
          .policy-hero-desc { font-size: 1rem; }
          
          .policy-layout { grid-template-columns: 1fr; padding: 0 16px; gap: 24px; }
          .policy-sidebar { position: static; max-height: none; margin-bottom: 0px; }
          .policy-main-content { padding: 24px 16px; }
          .policy-main-content h2 { align-items: flex-start !important; line-height: 1.4; }
          .policy-main-content h2 svg { flex-shrink: 0; margin-top: 4px; }
      ...
      <div className="policy-hero-section">
        <h1 className="policy-hero-title">Complete Cancellation Guidelines</h1>
      ...
      <div className="policy-layout">
        ...
        {/* MAIN CONTENT AREA */}
        <div className="policy-main-content card-panel">
